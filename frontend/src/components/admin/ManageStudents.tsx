  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:ml-72 flex flex-col">
        ...
        <main className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Manage Students</h1>
